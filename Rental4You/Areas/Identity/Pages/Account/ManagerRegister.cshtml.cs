...
namespace Rental4You.Areas.Identity.Pages.Account
{
    public class ManagerRegisterModel : PageModel
    {
        ...
        private readonly ILogger<ManagerRegisterModel> _logger;
        private readonly IEmailSender _emailSender;
        private readonly ApplicationDbContext _context;

        public ManagerRegisterModel(SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, IUserStore<ApplicationUser> userStore, ILogger<ManagerRegisterModel> logger, IEmailSender emailSender, ApplicationDbContext context)
        {
